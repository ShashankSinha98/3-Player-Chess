        ...
        {//left-up
            ...
            {//if on this sqhuare isn't piece
                ...
                {//white
                    ...
                    if (this.chessboard.getKingWhite().willBeSafeWhenMoveOtherPiece(this.square, chessboard.squares[h][i]))
                    {
                ...
                {//or black
                    if (this.chessboard.getKingBlack().willBeSafeWhenMoveOtherPiece(this.square, chessboard.squares[h][i]))
                    {
                        list.add(chessboard.squares[h][i]);
                    }
                }
