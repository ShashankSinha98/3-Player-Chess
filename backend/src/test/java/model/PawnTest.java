 ...
 class PawnTest {
    ...
    @Test
     ...
     void isLegalMove_pawnMoveForwardToEmptySquare_True() {
         ...
         assertTrue(pawn.isLegalMove(board, BE4, RD4));
     }
    ...
    @ParameterizedTest
     ...
     void isLegalMove_pawnMoveDiagonalToTakeOpponentPiece_True(BasePiece piece) {
        ...
        assertTrue(pawn.isLegalMove(board, startPosition, endPosition));
    }
     ...
     void isLegalMove_pawnTakesItsColourPiece_False(BasePiece piece) {
        ...
        assertFalse(pawn.isLegalMove(board, startPosition, endPosition));
    }
     ...
     void getHighlightPolygons_pawnInitialPosition_presentInPolygonList() {
         ...
         Set<Position> actualPawnMoves = pawn.getHighlightPolygons(board, startPosition);
