 ...
 class QueenTest {
    ...
    @Test
     ...
     void isLegalMove_queenMovesToEmptySquare_True(Colour colour) {
         ...
         assertTrue(queen.isLegalMove(board.boardMap, queenPosition, GF3));
     }
     ...
     void isLegalMove_queenTakesItsColourPiece_False(BasePiece piece) {
         ...
         assertFalse(queen.isLegalMove(board.boardMap, startPosition, endPosition));
     }
     ...
     void isLegalMove_queenTakesDifferentColourPiece_True(BasePiece piece) {
         ...
         assertTrue(queen.isLegalMove(board.boardMap, startPosition, endPosition));
     }
     ...
     void getHighlightPolygons_validPolygons_presentInPolygonList(Colour colour) {
         ...
         Set<Position> actualQueenMoves = queen.getHighlightPolygons(board.boardMap, startPosition);
